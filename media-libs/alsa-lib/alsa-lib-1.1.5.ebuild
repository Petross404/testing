...
inherit autotools eutils multilib multilib-minimal python-single-r1 flag-o-matic
...
PATCHES=(
	"${FILESDIR}/alsa.patch" \
	"${FILESDIR}/alsa_timer.patch" \
	"${FILESDIR}/snd_pcm.patch" \
	#"${FILESDIR}/pcm_direct.patch"
	)
...
multilib_src_configure() {
	...
	append-flags "-ffat-lto-objects -flto-compression-level=8 -flto-partition=balanced"
