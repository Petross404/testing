...
DESCRIPTION="Qt dock widget library written by KDAB"
...
src_configure() {
	local mycmakeargs+=(
		...
		-DKDDockWidgets_EXAMPLES=$(usex examples)
		#-DKDDockWidgets_PYTHON_BINDINGS=$(usex python)
		-DKDDockWidgets_QTQUICK=$(usex qtquick)
	)
