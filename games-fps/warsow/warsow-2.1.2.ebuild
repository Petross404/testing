...
DATA_PV=2.1.2
UPDATE_P=${PN}_${DATA_PV}
ENGINE_PV=21
ENGINE_P=${PN}_${ENGINE_PV}_sdk

DESCRIPTION="Multiplayer FPS based on the QFusion engine (evolved from Quake 2)"
HOMEPAGE="http://www.warsow.net/"
SRC_URI="https://slice.sh/warsow/warsow-2.1.2.tar.gz
	https://slice.sh/warsow/warsow_21_sdk.tar.gz
...
src_compile() {
	emake -C source/libsrcs/angelscript/sdk/angelscript/projects/gnuc
