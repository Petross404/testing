...
PATCHES=( "${FILESDIR}/${P}-libcdio-1.0.0.patch"
          "${FILESDIR}/0001-Callback-in-_cdio_list_free-set-to-NULL.patch"
          "${FILESDIR}/0002-Callback-in-_cdio_list_node_free-set-to-NULL.patch"
          "${FILESDIR}/0003-Remove-flag-from-iso9660_fs_readdir.patch" )
